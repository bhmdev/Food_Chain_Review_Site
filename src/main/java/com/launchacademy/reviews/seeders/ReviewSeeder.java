...
public class ReviewSeeder {
  ...
  public void seed() {
    if(Lists.newArrayList(reviewRepository.findAll()).isEmpty()) {
      ...
      chickfilaReview1.setComment(
          "I literally go there so I can get the chick-fil-a sauce so I can eat it with all of my food.");
      ...
      for (FoodChain foodChain : foodChainRepository.findAll()) {
